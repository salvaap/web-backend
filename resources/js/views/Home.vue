<template>
  <div>
    <div v-observe-visibility="fixateSidebar">
      <div id="hero">
      ...
      <section class="w-full py-8 px-4 bg-gray-200">
    ...
    <section style="z-index: 101;" class="flex justify-between relative w-full py-8 bg-gray-200 shadow-inner">
      <div class="container mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="flex flex-wrap p-3 bg-white shadow">
          ...
          <div class="flex content-center flex-wrap w-2/3 pl-3">
            <span class="mb-0 font-bold text-xl leading-tight">Soporte Comprometido</span>
          </div>
        </div>
        <div class="flex flex-wrap p-3 bg-white shadow">
          <div class="w-1/3 text-accent-900">
...
export default {
  ...
  methods: {
    ...
    visibilityChanged(isVisible, entry) {
      this.$parent.menuFixed = !isVisible;
    },
    fixateSidebar(isVisible, entry) {
      this.navFixed = !isVisible;
    }
  }
}
</script>
